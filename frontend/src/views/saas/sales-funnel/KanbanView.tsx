...
const KanbanView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Visualiza tus negocios por etapa del embudo
            </p>
          </div>
      ...
      {error && <Card className="p-4 border border-red-200 bg-red-50 text-red-700">{error}</Card>}
              ...
              <Card key={stageKey} className="p-0 overflow-hidden">
                <div className="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full ${getStageColor(stageKey).split(' ')[0]}`}
                    ></div>
                ...
                <div className="p-3 space-y-3 min-h-[160px]">
                  {items.length === 0 && <div className="text-xs text-gray-500">Sin negocios</div>}
                  {items.map((lead) => (
                    <Card
                      key={lead.id}
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <Badge className="text-[10px]" color="gray">
                          {lead.lead_source || '—'}
                        </Badge>
                      </div>
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        <div className="w-16 bg-gray-200 rounded-full h-1.5">
                          <div
                            ...
                            style={{ width: `${lead.close_probability || 0}%` }}
                          />
                        </div>
