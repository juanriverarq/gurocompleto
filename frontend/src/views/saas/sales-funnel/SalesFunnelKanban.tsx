...
import salesFunnelService, { SalesFunnelLead, STAGES, formatCurrency } from 'src/services/salesFunnelService';
...
const SalesFunnelKanban: React.FC = () => {
  ...
  const estadisticas = {
    ...
    probabilidadPromedio: leads.length > 0 
  ...
  return (
    <div className="space-y-6">
      {/* Título */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Negocios - Vista Kanban</h1>
        <p className="text-gray-600 dark:text-gray-400">Arrastra y suelta para cambiar la etapa de los negocios</p>
      </div>
                ...
                <Droppable droppableId={stageKey} key={stageKey}>
                  {(provided, snapshot) => (
                    <div
                      ...
                      className={`rounded-lg w-[300px] p-5 ${STAGE_BACKGROUNDS[stageKey as keyof typeof STAGE_BACKGROUNDS]} ${
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center mb-4">
                        <div>
                          <h6 className="text-base font-semibold text-gray-900 dark:text-white">{stageName}</h6>
                          <p className="text-xs text-gray-500">{leadsByStage[stageKey]?.length || 0} negocios</p>
                        </div>
                        ...
                        {leadsByStage[stageKey]?.map((lead, index) => {
                          ...
                          return (
                            <Draggable 
                              ...
                              index={index}
                              isDragDisabled={movingLead === lead.id}
                            >
                              {(provided, snapshot) => (
                                <div
                                  ref={provided.innerRef}
                                ...
                                >
                                  ...
                                  <div className="flex justify-between items-start mb-3">
                                    ...
                                    >
                                      ...
                                      <Dropdown.Item 
                                        ...
                                        className="flex gap-2 items-center"
                                      >
                                        <IconifyIcon icon="solar:pen-new-square-bold-duotone" height={15} />
                                        Editar
                                      </Dropdown.Item>
                                      <Dropdown.Divider />
                                      <Dropdown.Item 
                                        ...
                                        className="flex gap-2 items-center"
                                      >
                                        <IconifyIcon icon="solar:refresh-circle-bold-duotone" height={15} />
                                        Cambiar Estado
                                      </Dropdown.Item>
                                    </Dropdown>
                                  </div>
                                  ...
                                  <div className="space-y-2 mb-3">
                                    {lead.email && (
                                      <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                                        <IconifyIcon icon="solar:letter-bold-duotone" className="w-3 h-3" />
                                        <span className="truncate">{lead.email}</span>
                                      </div>
                                    )}
                                    {lead.phone && (
                                      <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                                        <IconifyIcon icon="solar:phone-bold-duotone" className="w-3 h-3" />
                                  ...
                                  <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <Badge className={`${stageConfig.color} px-2 py-1 rounded-full text-xs`}>
                                      {stageConfig.label}
                                    </Badge>
                                  </div>
                                  ...
                                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                                    <div className="flex items-center gap-1">
                                      <IconifyIcon icon="solar:dollar-bold-duotone" className="w-4 h-4 text-green-600" />
                                      <span className="text-xs font-semibold text-gray-900 dark:text-white">
                                        {formatCurrency(lead.potential_value || 0)}
                                      </span>
                                    </div>
                                    <div className="flex items-center gap-1">
                                      <IconifyIcon icon="solar:chart-bold-duotone" className="w-4 h-4 text-blue-600" />
                                      <span className="text-xs font-semibold text-gray-900 dark:text-white">
                      ...
                      {(!leadsByStage[stageKey] || leadsByStage[stageKey].length === 0) && (
                        <div className="text-center py-8 text-gray-400 text-sm">
                          <IconifyIcon icon="solar:inbox-line-bold-duotone" className="w-12 h-12 mx-auto mb-2 opacity-50" />
                          <p>No hay negocios</p>
                        </div>
                      )}
                    </div>
