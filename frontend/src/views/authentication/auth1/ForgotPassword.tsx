          ...
          <div className="xl:col-span-4 lg:col-span-6 col-span-12 sm:px-12 px-4">
            <div className="flex h-screen items-center px-3 max-w-md mx-auto ">
              <div className="w-full">
                <Logo />
                <h3 className="text-2xl font-bold my-3 mt-5">Recuperar Contraseña</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm font-medium">
                  Ingresa el correo electrónico asociado con tu cuenta de Guro
                ...
                <Button
                  ...
                  as={Link}
                  to="/auth/auth1/login"
                  className="rounded-md w-full mt-4 hover:bg-primary hover:text-white transition-colors"
                >
