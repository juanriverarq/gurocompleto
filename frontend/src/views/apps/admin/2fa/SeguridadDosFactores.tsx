...
const BCrumb = [
  ...
  {
    title: 'SeguridadDosFactores',
  },
];

const SeguridadDosFactores: React.FC = () => {
  return (
    <>
      <BreadcrumbComp title="SeguridadDosFactores" items={BCrumb} />
...
export default SeguridadDosFactores;
