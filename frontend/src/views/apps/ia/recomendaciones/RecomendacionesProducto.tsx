...
const BCrumb = [
  ...
  {
    title: 'RecomendacionesProducto',
  },
];

const RecomendacionesProducto: React.FC = () => {
  return (
    <>
      <BreadcrumbComp title="RecomendacionesProducto" items={BCrumb} />
...
export default RecomendacionesProducto;
