...
import {
  ...
  HiSun,
  HiX
} from "./chunk-A4JIN3Q4.js";
import {
  GenIcon
} from "./chunk-F4UBDRNT.js";
import {
  require_classnames
} from "./chunk-XF7I6TKH.js";
import {
  require_jsx_runtime
...
function FloatingPortal(props) {
  ...
  return React2.createElement(PortalContext.Provider, {
    ...
    style: HIDDEN_STYLES
  }), portalNode && ReactDOM.createPortal(children, portalNode), shouldRenderGuards && portalNode && React2.createElement(FocusGuard, {
    "data-type": "outside",
    ref: afterOutsideRef,
    onFocus: (event) => {
      if (isOutsideEvent(event, portalNode)) {
...
var DatepickerRender = ({
  ...
  const effectiveDefaultView = (0, import_react24.useMemo)(() => {
  ...
  const [selectedDate, setSelectedDate] = (0, import_react24.useState)(value ?? initialDate);
  const [viewDate, setViewDate] = (0, import_react24.useState)(value ?? effectiveDefaultView);
