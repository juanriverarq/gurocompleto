        ...
        <div className="container">
          <div className="text-wrapper pb-60 position-relative">
            <h1
              ...
              data-aos="fade-up"
            >
              <span className="line-one">Sejanos,</span> Coberturas y Protección
              <span className="line-two">a tu medida</span> y más.
            </h1>
            ...
            <div className="d-sm-flex align-items-center justify-content-between">
              <div className="d-inline-block">
                ...
                <div className="mt-5">
                  <a
                    href="mailto:hola@janosejanos.com"
                    className="mail-info tran3s"
                  >
                    hola@janosejanos.com
                  </a>
                </div>
              </div>
              <Link
