...
const AboutUsV1 = () => {
  ...
  return (
    <>
      <Seo pageTitle="Sobre Nosotros V1" />
            ...
            <div className="col-lg-6">
              ...
              >
                <div className="title-style-six">
                  ...
                  <h2 className="main-title fw-500 tx-dark">
                    Everything with Protección.
                  </h2>
                </div>
                {/* /.title-style-ten */}
                <p className="fs-20 pt-20 pb-30 lg-pt-10 lg-pb-20">
                  Convierte tu tranquilidad en prioridad hoy with lorem
            ...
            <div className="row align-items-center">
              <div className="col-lg-5" data-aos="fade-right">
                <div className="title-style-six text-center text-lg-start pb-40 lg-pb-20 md-pb-10">
                  <h2 className="main-title fw-500 tx-dark">Nuestro Equipo</h2>
                </div>
                {/* /.title-style-six */}
              </div>
            </div>
